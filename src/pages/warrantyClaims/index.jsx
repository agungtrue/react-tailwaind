...
function WarrantyClaims({ children }) {
    const [isLoading, setIsLoading] = useState(false);
    const [warrantyClaims, setWarrantyClaims] = useState(false);

    useEffect(() => {
        setIsLoading(true);
        setWarrantyClaims(warrantyClaimList.data)
      ...
      <div className="containers">
          ...
          <div className="flex">
              ...
              {!isLoading && (
                ...
                >
                    <div className="pt-4 uppercase" style={{ paddingLeft: '3rem' }}>Warranty Claims</div>
                                    ...
                                    <table className="w-full table-auto">
                                        <thead>
                                            <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                                ...
                                                <th className="py-3 px-6 text-left">Request By</th>
                                                <th className="py-3 px-6 text-left">Staff (Handle By)</th>
                                        ...
                                        <tbody className="text-gray-600 text-sm font-light">
                                            {Boolean(warrantyClaims.length) && warrantyClaims.map((warranty) => (
                                                <tr className="border-b border-gray-200 hover:bg-gray-100" key={warranty._id}>
                                                    ...
                                                    <td className="py-3 px-6 text-center">
                                                        <div className="flex items-center">
                                                            <span>{ warranty.serialNumberProduct}</span>
                                                        </div>
                                                    </td>
                                                    <td className="py-3 px-6 text-center whitespace-nowrap">
                                                        <div className="flex items-center">
                                                            <span className="font-medium">{ warranty.customerId?.username }</span>
                                                        </div>
                                                    </td>
                                                    <td className="py-3 px-6 text-center">
                                                        <div className="flex items-center">
                                                            <span className="font-medium">{ warranty.handledBy?.username || '-' }</span>
                                                        </div>
                                                    </td>
                                                    <td className="py-3 px-6 text-center">
                                                    ...
                                                    <td className="py-3 px-6 text-center">
                                                        <div className="flex item-center justify-center">
                                                            <span>{ warranty.createdAt }</span>
                                                        </div>
                                                    </td>
                                                    <td className="py-3 px-6 text-center">
                                                        <div className="flex item-center justify-center">
                                                            <div className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                                <Link to={`/warranty-claims/${warranty._id}`}>
