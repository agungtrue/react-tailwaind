      ...
      <div className="containers">
          ...
          <div className="flex">
              ...
              {!isLoading && (
                ...
                >
                    <div className="pt-4" style={{ paddingLeft: '3rem' }}>CUSTOMERS</div>
                                ...
                                <div className="bg-white shadow-md rounded my-6">
                                    <table className="w-full table-auto">
                                        ...
                                        <tbody className="text-gray-600 text-sm font-light">
                                            {Boolean(customerData.length) && customerData.map((customer) => (
                                                <tr className="border-b border-gray-200 hover:bg-gray-100" key={customer._id}>
                                                    <td className="py-3 px-6 text-left whitespace-nowrap">
                                                        <div className="flex items-center">
                                                            <div className="mr-2">
                                                            <img className="w-6 h-6 rounded-full" src="https://randomuser.me/api/portraits/men/1.jpg" alt="randomuser" />
                                                            </div>
