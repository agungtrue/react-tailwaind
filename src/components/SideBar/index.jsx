    ...
    return (
        <div className="">
            <aside className="w-64" aria-label="Sidebar">
                <div className="px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800" style={{ minHeight: '100vh' }}>
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Warranty Claims</span>
            ...
            {/* This sidebar component is part of a larger, open-source library of Tailwind CSS components. Learn
