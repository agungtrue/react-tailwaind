            ...
            <div className="flex-initial">
                <div className="flex justify-end items-center relative">
                    ...
                    <div className="flex mr-4 items-center">
                        <button className="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" href="#">
                            <div className="flex items-center relative cursor-pointer whitespace-nowrap">Hello, Agung!</div>
                        </button>
